...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__disease__ = __webpack_require__(886);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ngx_bootstrap__ = __webpack_require__(518);
...
DiseaseModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_3__angular_core__["NgModule"])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_0__disease__["a" /* DiseasePage */]
        ],
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_0__disease__["a" /* DiseasePage */])
        ],
        entryComponents: [
            __WEBPACK_IMPORTED_MODULE_0__disease__["a" /* DiseasePage */]
        ]
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_diseases_diseases__ = __webpack_require__(887);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DiseasePage = (function () {
    function DiseasePage(navCtrl, navParams, modalCtrl, alertCtrl, diseaseProvider) {
    ...
    DiseasePage.prototype.ngOnInit = function () {
        var _this = this;
        this.diseaseProvider.getDiseases()
            .subscribe(function (dis) {
            _this.diseases = dis;
            _this.bigTotalItems = _this.diseases.length;
            _this.pageChanged({ page: 1 })
                ,
                    function (err) { return console.log(err); };
        });
    };
    DiseasePage.prototype.pageChanged = function (_a) {
        var _this = this;
        var page = _a.page;
        this.diseasesData = this.diseases.filter(function (value, index) {
            if (index >= _this.itemsPerPage * (page - 1) && index < page * _this.itemsPerPage) {
                return value;
            }
        });
    };
    DiseasePage.prototype.viewDiseases = function (dis) {
        var modal = this.modalCtrl.create('disease-details', { dis: dis });
        modal.onDidDismiss(function (data) { });
        modal.present();
    };
    DiseasePage.prototype.addDisease = function () {
        var modal = this.modalCtrl.create('add-disease');
        modal.onDidDismiss(function (data) { });
        modal.present();
    };
    DiseasePage.prototype.deleteDisease = function (disease) {
...
DiseasePage = __decorate([
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-disease',template:/*ion-inline-start:"/root/Templates/IONIC/WebIonic/src/pages/disease/disease.html"*/'<!--\n  Generated template for the DiseasePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar color="primary">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Diseases</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <div class="table-responsive">\n    <table class="table">\n      <thead>\n      <tr>\n\n        <th>\n          #\n        </th>\n\n        <th\n          icon-only\n          tooltip="Toggle to sort by name"\n          duration="1000"\n          positionH="right"\n          arrow>\n          Name\n          <!--<ion-icon-->\n            <!--[name]="(eT==undefined)?\'code\':(eT==true)?\'arrow-dropup\':\'arrow-dropdown\'"-->\n            <!--class="float-right"-->\n            <!--(click)="sort.exporter()">-->\n          <!--</ion-icon>-->\n        </th>\n\n        <th>\n          Photo\n        </th>\n\n        <th\n          icon-only\n          tooltip="Toggle to sort by category"\n          duration="1000"\n          positionH="right"\n          arrow>\n          Cause\n          <!--<ion-icon-->\n            <!--[name]="(qT==undefined)?\'code\':(qT==true)?\'arrow-dropup \':\'arrow-dropdown\'"-->\n            <!--class="float-right"-->\n            <!--(click)="sort.quantity()">-->\n          <!--</ion-icon>-->\n        </th>\n\n        <th>\n          Crop\n        </th>\n\n        <th>\n          Control\n        </th>\n\n        <th>Actions\n          <!--<ion-icon-->\n            <!--class="ion-ios-funnel float-right"-->\n            <!--(click)="filters=!filters"-->\n            <!--tooltip="Toggle to filter"-->\n            <!--positionH="left"-->\n            <!--arrow-->\n            <!--duration="1000">-->\n          <!--</ion-icon>-->\n        </th>\n      </tr>\n\n      <tr *ngIf="filters">\n        <th></th>\n        <th>\n          <ion-item>\n            <ion-label floating>Name</ion-label>\n            <ion-input type="text"></ion-input>\n          </ion-item>\n        </th>\n        <th>\n        </th>\n        <th>\n        </th>\n        <th></th>\n        <th></th>\n        <th>\n          <ion-item>\n            <ion-label floating>Crop</ion-label>\n            <ion-input type="text"></ion-input>\n          </ion-item>\n        </th>\n        <th>\n        </th>\n        <th>\n        </th>\n\n        <th></th>\n      </tr>\n      </thead>\n      <tbody>\n      <tr *ngFor="let disease of diseasesData; let i = index">\n        <td>{{(itemsPerPage*(bigCurrentPage-1))+(i+1)}}</td>\n        <td text-capitalize text-wrap text-justify>{{disease?.name}}</td>\n        <td>\n          <ion-img [src]="disease?.photo_url" style="width: 100px; height: 67px;"></ion-img>\n        </td>\n        <td text-capitalize>{{disease?.cause}}</td>\n        <td text-capitalize>{{disease?.crop}}</td>\n        <td text-wrap text-justify>{{disease?.control}}</td>\n        <td>\n          <div class="btn-group">\n            <button  icon-only color="primary" ion-button (click)="viewDiseases(disease)" >\n              <ion-icon name="ios-eye"></ion-icon>\n            </button>\n            <button  icon-only color="secondary" ion-button >\n              <ion-icon name="ios-brush"></ion-icon>\n            </button>\n            <button  icon-only color="danger" ion-button (click)="deleteDisease(disease)">\n              <ion-icon name="md-close"></ion-icon>\n            </button>\n          </div>\n        </td>\n      </tr>\n      </tbody>\n    </table>\n  </div>\n  <div class="col-md-6">\n    <pagination\n      previousText="&lsaquo;" nextText="&rsaquo;" firstText="&laquo;" lastText="&raquo;"\n      [totalItems]="bigTotalItems" [(ngModel)]="bigCurrentPage" [maxSize]="maxSize" [itemsPerPage]="itemsPerPage"\n      class="pagination-sm"\n      [boundaryLinks]="true" [rotate]="false" (pageChanged)="pageChanged($event)"></pagination>\n  </div>\n\n  <ion-fab right bottom>\n    <button ion-fab color="dark" (click)="addDisease()"><ion-icon name="add"></ion-icon></button>\n  </ion-fab>\n</ion-content>\n'/*ion-inline-end:"/root/Templates/IONIC/WebIonic/src/pages/disease/disease.html"*/,
        providers: [__WEBPACK_IMPORTED_MODULE_2__providers_diseases_diseases__["a" /* DiseasesProvider */]]
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* ModalController */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */],
        __WEBPACK_IMPORTED_MODULE_2__providers_diseases_diseases__["a" /* DiseasesProvider */]])
], DiseasePage);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DiseasesProvider; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
...
var DiseasesProvider = (function () {
    function DiseasesProvider(http, global) {
        this.http = http;
        this.global = global;
    }
...
DiseasesProvider = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Http */], __WEBPACK_IMPORTED_MODULE_3__global_global__["a" /* GlobalProvider */]])
], DiseasesProvider);
