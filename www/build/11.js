...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__dashboard__ = __webpack_require__(838);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pipes_pipes_module__ = __webpack_require__(566);
...
DashboardModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_3__angular_core__["NgModule"])({
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_0__dashboard__["a" /* DashboardPage */])
        ],
        entryComponents: [
            __WEBPACK_IMPORTED_MODULE_0__dashboard__["a" /* DashboardPage */]
        ],
...
/* MIT license */
var cssKeywords = __webpack_require__(832);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_dashboard_dashboard__ = __webpack_require__(839);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_chart_js__ = __webpack_require__(840);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_chart_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_chart_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_global_global__ = __webpack_require__(51);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DashboardPage = (function () {
    function DashboardPage(navCtrl, navParams, globals, dashProvider) {
    ...
    DashboardPage.prototype.ngOnInit = function () {
        ...
        this.dashProvider.getFarmers()
            .subscribe(function (stat) { return _this.accStat = stat; }, function (err) { return console.log(err); });
        this.dashProvider.getPayments()
            .subscribe(function (cash) { return _this.cash = cash.payments; }, function (err) { return console.log(err); });
        this.dashProvider.getEnquiries()
            .subscribe(function (enq) { return _this.enquiries = enq; }, function (err) { return console.log(err); });
        this.dashProvider.getNewOrdersNo()
            .subscribe(function (orderNo) { return _this.ordersNo = orderNo; }, function (err) { return console.log(err); });
        this.dashProvider.getOrdersChart().subscribe(function (ordersChart) {
            _this.barChart = new __WEBPACK_IMPORTED_MODULE_3_chart_js__["Chart"](_this.barCanvas.nativeElement, {
                type: 'bar',
                data: {
                    labels: _this.globals.months,
                    datasets: [
                        {
                            label: "Complete",
        ...
        this.dashProvider.getSubscribersChart().subscribe(function (subscribersChart) {
        ...
        this.dashProvider.getInputsChart().subscribe(function (inputsChart) {
            _this.donutChart = new __WEBPACK_IMPORTED_MODULE_3_chart_js__["Chart"](_this.donutCanvas.nativeElement, {
                type: 'doughnut',
                data: {
        ...
        this.dashProvider.getOrdersPortionChart().subscribe(function (ordersPChart) {
            _this.pieChart = new __WEBPACK_IMPORTED_MODULE_3_chart_js__["Chart"](_this.pieCanvas.nativeElement, {
                type: 'pie',
                data: {
    ...
    DashboardPage.prototype.root = function (page) {
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('donutCanvas'),
    __metadata("design:type", Object)
], DashboardPage.prototype, "donutCanvas", void 0);
__decorate([
...
DashboardPage = __decorate([
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-dashboard',template:/*ion-inline-start:"/root/Templates/IONIC/WebIonic/src/pages/dashboard/dashboard.html"*/'<!--\n  Generated template for the DashboardPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar color="primary">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Dashboard</ion-title>\n    <ion-buttons end>\n      <button ion-button>\n        Sales\n      </button>\n      <button ion-button clear notification-button>\n        <ion-icon name="md-mail">\n          <ion-badge  color="secondary" notifications-badge-secondary>5</ion-badge>\n        </ion-icon>\n      </button>\n      <button ion-button clear notification-button>\n        <ion-icon name="md-notifications">\n          <ion-badge  color="danger" notifications-badge>5</ion-badge>\n        </ion-icon>\n      </button>\n      <button ion-button notification-button>\n        <ion-icon name="md-settings"></ion-icon>\n      </button>\n      <button ion-button notification-button>\n        <ion-icon name="md-log-out"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n<ion-grid>\n  <ion-row>\n    <ion-col col-12 col-lg-3 col-md-6 col-sm-12 col-xl-3 no-padding>\n      <ion-card data-background-color="blue">\n        <ion-card-content>\n          <ion-item>\n            <div item-start >\n              <div class="dash-box-text-font" white>{{ordersNo?.no | cash}}</div>\n              <h2 class="text-white">New Orders</h2>\n            </div>\n            <div item-end>\n              <ion-icon name="ios-cart" dash-box-font translucent-inner></ion-icon>\n            </div>\n          </ion-item>\n        </ion-card-content>\n        <ion-row translucent>\n          <ion-col text-center white (click)="root(\'received-orders\')" hand="true">\n            More Info\n            <ion-icon color="light" name="ios-arrow-dropright-circle" item-right></ion-icon>\n          </ion-col>\n        </ion-row>\n      </ion-card>\n    </ion-col>\n    <ion-col col-12 col-lg-3 col-md-6 col-sm-12 col-xl-3 no-padding>\n      <ion-card data-background-color="green">\n        <ion-card-content>\n          <ion-item>\n            <div item-start white>\n              <div class="dash-box-text-font">{{enquiries | cash}}</div>\n              <h2 class="text-white">New Enquiries</h2>\n            </div>\n            <div item-end>\n              <ion-icon name="ios-chatbubbles" dash-box-font translucent-inner></ion-icon>\n            </div>\n          </ion-item>\n        </ion-card-content>\n        <ion-row translucent>\n          <ion-col text-center white hand="true" (click)="root(\'enquiries\')">\n            More Info\n            <ion-icon color="light" name="ios-arrow-dropright-circle" item-right></ion-icon>\n          </ion-col>\n        </ion-row>\n      </ion-card>\n    </ion-col>\n    <ion-col col-12 col-lg-3 col-md-6 col-sm-12 col-xl-3 no-padding>\n      <ion-card data-background-color="purple">\n        <ion-card-content>\n          <ion-item>\n            <div item-start white>\n              <div class="dash-box-text-font">{{cash | cash}}</div>\n              <h2 class="text-white">Payments</h2>\n            </div>\n            <div item-end>\n              <ion-icon name="ios-cash" dash-box-font translucent-inner></ion-icon>\n            </div>\n          </ion-item>\n        </ion-card-content>\n        <ion-row translucent>\n          <ion-col text-center white hand="true">\n            More Info\n            <ion-icon color="light" name="ios-arrow-dropright-circle" item-right></ion-icon>\n          </ion-col>\n        </ion-row>\n      </ion-card>\n    </ion-col>\n    <ion-col col-12 col-lg-3 col-md-6 col-sm-12 col-xl-3 no-padding>\n      <ion-card data-background-color="red">\n        <ion-card-content>\n          <ion-item>\n            <div item-start white>\n              <div class="dash-box-text-font">{{accStat?.f | cash}}</div>\n              <h2 class="text-white">Farmers</h2>\n            </div>\n            <div item-end>\n              <ion-icon name="ios-people" dash-box-font translucent-inner></ion-icon>\n            </div>\n          </ion-item>\n        </ion-card-content>\n        <ion-row translucent>\n          <ion-col text-center white hand="true">\n            More Info\n            <ion-icon color="light" name="ios-arrow-dropright-circle" item-right></ion-icon>\n          </ion-col>\n        </ion-row>\n      </ion-card>\n    </ion-col>\n  </ion-row>\n  <ion-row>\n    <ion-col col-12  col-lg-6 col-md-12 col-sm-12 col-xl-6 no-padding>\n      <ion-card data-background-color="blue">\n        <ion-card-header text-center>\n          Orders\n        </ion-card-header>\n        <ion-card-content>\n          <canvas #barCanvas height="160"></canvas>\n        </ion-card-content>\n      </ion-card>\n    </ion-col>\n\n    <ion-col col-12  col-lg-6 col-md-12 col-sm-12 col-xl-6 no-padding>\n      <ion-card data-background-color="orange">\n        <ion-card-header text-center>\n          Subscribers\n        </ion-card-header>\n        <ion-card-content>\n          <canvas #lineCanvas height="160"></canvas>\n        </ion-card-content>\n      </ion-card>\n    </ion-col>\n\n    <ion-col col-12  col-lg-6 col-md-12 col-sm-12 col-xl-6 no-padding>\n      <ion-card data-background-color="red">\n        <ion-card-header text-center>\n          Order Proportion\n        </ion-card-header>\n        <ion-card-content>\n          <canvas #pieCanvas height="160"></canvas>\n        </ion-card-content>\n      </ion-card>\n    </ion-col>\n\n    <ion-col col-12  col-lg-6 col-md-12 col-sm-12 col-xl-6 no-padding>\n      <ion-card data-background-color="green">\n        <ion-card-header text-center>\n          Inputs\n        </ion-card-header>\n        <ion-card-content>\n          <canvas #donutCanvas height="160"></canvas>\n        </ion-card-content>\n      </ion-card>\n    </ion-col>\n\n  </ion-row>\n</ion-grid>\n</ion-content>\n'/*ion-inline-end:"/root/Templates/IONIC/WebIonic/src/pages/dashboard/dashboard.html"*/,
        providers: [__WEBPACK_IMPORTED_MODULE_2__providers_dashboard_dashboard__["a" /* DashboardProvider */]]
    }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_catch__ = __webpack_require__(564);
...
var DashboardProvider = (function () {
    function DashboardProvider(http, global) {
        this.http = http;
        this.global = global;
    }
 ...
 * @namespace Chart
 */
var Chart = __webpack_require__(841)();

__webpack_require__(842)(Chart);
__webpack_require__(846)(Chart);
__webpack_require__(848)(Chart);
__webpack_require__(849)(Chart);
__webpack_require__(850)(Chart);
...
__webpack_require__(878)(Chart);
__webpack_require__(879)(Chart);
__webpack_require__(880)(Chart);
__webpack_require__(881)(Chart);
__webpack_require__(882)(Chart);

// Loading built-it plugins
var plugins = [];

plugins.push(
    __webpack_require__(883)(Chart),
    __webpack_require__(884)(Chart),
    __webpack_require__(885)(Chart)
);
...
var color = __webpack_require__(830);
...
var conversions = __webpack_require__(831);
...
/* MIT license */
var colorNames = __webpack_require__(832);
...
var implementation = __webpack_require__(847);
...
var moment = __webpack_require__(272);
