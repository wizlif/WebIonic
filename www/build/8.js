webpackJsonp([8],Array(266).concat([
/* 266 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PestsModule", function() { return PestsModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pests__ = __webpack_require__(894);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ngx_bootstrap__ = __webpack_require__(518);
...
var PestsModule = (function () {
    function PestsModule() {
    }
    return PestsModule;
}());
PestsModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_3__angular_core__["NgModule"])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_0__pests__["a" /* PestsPage */]
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_2_ngx_bootstrap__["a" /* PaginationModule */].forRoot(),
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_0__pests__["a" /* PestsPage */])
        ],
        entryComponents: [
            __WEBPACK_IMPORTED_MODULE_0__pests__["a" /* PestsPage */]
        ]
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PestsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_pests_pests__ = __webpack_require__(895);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PestsPage = (function () {
    function PestsPage(navCtrl, navParams, modalCtrl, alertCtrl, pestsProvider) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.modalCtrl = modalCtrl;
        this.alertCtrl = alertCtrl;
        this.pestsProvider = pestsProvider;
        this.maxSize = 5;
        this.bigTotalItems = 0;
        this.bigCurrentPage = 1;
        this.itemsPerPage = 4;
    }
    PestsPage.prototype.ngOnInit = function () {
        var _this = this;
        this.pestsProvider.getPests()
            .subscribe(function (pst) {
            _this.pests = pst;
            _this.bigTotalItems = _this.pests.length;
            _this.pageChanged({ page: 1 })
                ,
                    function (err) { return console.log(err); };
        });
    };
    PestsPage.prototype.pageChanged = function (_a) {
        var _this = this;
        var page = _a.page;
        this.pestsData = this.pests.filter(function (value, index) {
            if (index >= _this.itemsPerPage * (page - 1) && index < page * _this.itemsPerPage) {
                return value;
            }
        });
    };
    PestsPage.prototype.viewPests = function (pest) {
        // let modal = this.modalCtrl.create('disease-details',{dis:dis});
        // modal.onDidDismiss(data=>{});
        // modal.present();
    };
    PestsPage.prototype.addPest = function () {
        var modal = this.modalCtrl.create('add-pest');
        modal.onDidDismiss(function (data) { });
        modal.present();
    };
    PestsPage.prototype.deletePest = function (pest) {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PestsProvider; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__global_global__ = __webpack_require__(51);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
*/
var PestsProvider = (function () {
    function PestsProvider(http, global) {
        this.http = http;
        this.global = global;
    }
    ...
    return PestsProvider;
}());
PestsProvider = __decorate([
